  ...
  return (
    <>
      <div className="mb-5 p-5 bg-gray-900 rounded-2xl shadow-xl border border-gray-800">
        <div className="flex items-center border border-gray-700 rounded-xl overflow-hidden focus-within:ring-4 focus-within:ring-green-600/50 transition duration-300 bg-gray-800">

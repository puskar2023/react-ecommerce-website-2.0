    ...
    <div className="container mx-auto md:px-8 pt-12">
      <div className='p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto text-center mt-12 border border-green-700 text-white'>
       ...
       <p>{deliveryDetails?.city},{deliveryDetails?.zip}</p>
        ...
        <Link
              to={"/"}
              className="mt-10 px-4 py-4 bg-green-600 text-white font-extrabold rounded-full shadow-lg shadow-green-800/50 cursor-pointer hover:bg-green-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-green-600/50 uppercase tracking-wider"
            >
